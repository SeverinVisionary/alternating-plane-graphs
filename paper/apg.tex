...
Which orders actually depend on this? Of $46,\dots,120$, exactly
$46, 47, 49, 50, 52, 55, 58, 61, 64$ have no insertion route $n + 3d$, $d \ge 1$,
from a spliceable certificate. Six of those --- $46, 47, 49, 50, 52, 55$ ---
carry their own certificate, so only $58$, $61$ and $64$ rest on the deletion
direction, through the floors $50$ and $52$, which are themselves obtained by
deletion. This set is computed from the spliceable orders rather than asserted
(\texttt{test\_conjecture\_coverage.py}). An earlier version of this remark
listed $57, 58, 59, 61, 63$; that enumeration was wrong in both directions and
is corrected here. Tightening the hypothesis to cover deletion uniformly is left
open; nothing else in this paper depends on it.
\end{remark}
