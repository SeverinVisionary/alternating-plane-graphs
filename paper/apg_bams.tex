...
applied twice, and unconditionally: such a graph is bridgeless however the
definition is read at a bridge.
...
\item \emph{Software.} The four decision procedures, the search programs that
  ...
  assistance.
\item \emph{Mathematics.} The step in \S\ref{sec:c2} that removes the (C2)
  hypothesis, and so makes Theorem~\ref{thm:101} unconditional, was proposed by
  an AI reviewer. The author re-derived it independently, and every bound it
