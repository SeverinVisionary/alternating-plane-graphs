...
\item \emph{Drafting.} The manuscript was drafted with AI assistance. The author
  has read and revised every sentence of it and is answerable for each one.
\end{itemize}

% ^^ AUTHOR: the final sentence above must be true before submission.  If you
%    have not personally read and revised every sentence, either do so now or
%    strike that clause.  Do not submit it otherwise.
