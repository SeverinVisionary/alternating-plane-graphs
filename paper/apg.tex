...
$54$ orders in all, each certified by an explicit witness.
\end{theorem}
...
lists $17$ verifier conditions with no negative control, and in September 2026
three coverage gates were found to be iterating an empty set. Both are recorded
in the artifact rather than corrected in silence.
...
resolves to the current version; the version this paper describes is~$1.0.2$,
\href{https://doi.org/10.5281/zenodo.22294497}{10.5281/zenodo.22294497}.
