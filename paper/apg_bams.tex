...
readings. The corresponding statement for $2,Y$ is
...
of \S\ref{sec:103} and, at orders $37$ and $38$, the disk surgery of this paper
--- those two are out of reach of the Section-8 arithmetic and are skipped by
the coverage list of \cite{AHSSV2015}. Orders $46$ through $56$, $67$
...
verified certificates. Of $46,\dots,120$, exactly $46, 47, 49, 50, 52, 55, 58,
61, 64$ have no insertion route $n+3d$, $d \ge 1$, from a spliceable
certificate, and all but $58$, $61$ and $64$ carry a certificate of their own;
so only those three rest on the deletion direction. The set is computed rather
than asserted. Tightening the hypothesis to cover deletion uniformly is left
open; nothing else here depends on it.
\end{remark}
